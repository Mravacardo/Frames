...
b4_button = Button(frame, text="Pastry", fg="green",bg="yellow")
b4_button.pack(side=BOTTOM)

b5_button = Button(frame, text="Cake", fg="green",bg="pink")
b5_button.pack(side=BOTTOM)

b6_button = Button(frame, text="Tiramisu", fg="green",bg="cyan")
